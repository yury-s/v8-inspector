...
public:
    ...
    void setIsPageContext(bool value)
    {
        this->setBoolean("isPageContext", value);
    }
};
...
public:
    enum {
        ...
        SendStartSet = 1 << 10,
        SendEndSet = 1 << 11,
        ReceiveHeadersEndSet = 1 << 12,
        AllFieldsSet = (RequestTimeSet | ProxyStartSet | ProxyEndSet | DnsStartSet | DnsEndSet | ConnectStartSet | ConnectEndSet | SslStartSet | SslEndSet | WorkerStartSet | SendStartSet | SendEndSet | ReceiveHeadersEndSet)
    };
...
struct PseudoType {
    enum Enum {
        ...
        Backdrop = 60,
        Selection = 61,
        First_line_inherited = 62,
        Scrollbar = 63,
        Scrollbar_thumb = 64,
        Scrollbar_button = 65,
        Scrollbar_track = 66,
        Scrollbar_track_piece = 67,
        Scrollbar_corner = 68,
        Resizer = 69,
        Input_list_button = 70,
    };
}; // struct PseudoType
...
public:
    ...
    struct Type {
        enum Enum {
            RepaintsOnScroll = 112,
            TouchEventHandler = 113,
            WheelEventHandler = 114,
        };
    }; // struct Type
...
class AnimationPlayer : public JSONObjectBase {
public:
    // Named after property name 'type' while generating AnimationPlayer.
    struct Type {
        enum Enum {
            CSSTransition = 115,
            CSSAnimation = 116,
    ...
    private:
        ...
        Builder(PassRefPtr</*AnimationPlayer*/JSONObject> ptr)
        {
            static_assert(STATE == NoFieldsSet, "builder should not be created in non-init state");
            m_result = ptr;
        }
    ...
    public:
        ...
        Builder<STATE | SourceSet>& setSource(PassRefPtr<TypeBuilder::Animation::AnimationNode> value)
        {
            static_assert(!(STATE & SourceSet), "property source should not be set yet");
        ...
        operator RefPtr<AnimationPlayer>& ()
        {
            static_assert(STATE == AllFieldsSet, "state should be AllFieldsSet");
            static_assert(sizeof(AnimationPlayer) == sizeof(JSONObject), "AnimationPlayer should be the same size as JSONObject");
            return *reinterpret_cast<RefPtr<AnimationPlayer>*>(&m_result);
        }

        PassRefPtr<AnimationPlayer> release()
        {
            return RefPtr<AnimationPlayer>(*this).release();
        }
    };

    /*
     * Synthetic constructor:
     * RefPtr<AnimationPlayer> result = AnimationPlayer::create()
     *     .setId(...)
     *     .setPausedState(...)
     *     .setPlayState(...)
     *     .setPlaybackRate(...)
...
class AnimationNode : public JSONObjectBase {
public:
    enum {
        NoFieldsSet = 0,
        DelaySet = 1 << 0,
    ...
    private:
        ...
        Builder(PassRefPtr</*AnimationNode*/JSONObject> ptr)
        {
            static_assert(STATE == NoFieldsSet, "builder should not be created in non-init state");
            m_result = ptr;
        }
    ...
    public:
        ...
        operator RefPtr<AnimationNode>& ()
        {
            static_assert(STATE == AllFieldsSet, "state should be AllFieldsSet");
            static_assert(sizeof(AnimationNode) == sizeof(JSONObject), "AnimationNode should be the same size as JSONObject");
            return *reinterpret_cast<RefPtr<AnimationNode>*>(&m_result);
        }

        PassRefPtr<AnimationNode> release()
        {
            return RefPtr<AnimationNode>(*this).release();
        }
    };

    /*
     * Synthetic constructor:
     * RefPtr<AnimationNode> result = AnimationNode::create()
     *     .setDelay(...)
     *     .setEndDelay(...)
     *     .setPlaybackRate(...)
     *     .setIterationStart(...)
