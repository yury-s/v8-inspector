...
public:
    ...
    public:
        ...
        void animationPlayerCreated(PassRefPtr<TypeBuilder::Animation::AnimationPlayer> player, bool resetTimeline);
        void animationPlayerCanceled(const String& playerId);
