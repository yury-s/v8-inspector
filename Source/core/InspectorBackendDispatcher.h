...
public:
    ...
    public:
        virtual void enable(ErrorString*) = 0;
        virtual void getAnimationPlayersForNode(ErrorString*, int in_nodeId, bool in_includeSubtreeAnimations, RefPtr<TypeBuilder::Array<TypeBuilder::Animation::AnimationPlayer> >& out_animationPlayers) = 0;
    ...
    enum MethodNames {
        ...
        kAnimation_getAnimationPlayersForNodeCmd,
